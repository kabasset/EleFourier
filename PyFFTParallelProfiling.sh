...
#SBATCH --ntasks 40                    # Run a single task (by default tasks == CPU)
...
END=40
for i in $(seq 1 $END); do time ./build.x86_64-conda_cos6-gcc93-o2g/run PyFFTParallel -l 40 -p 40 -b $i; done